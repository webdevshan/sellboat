      ...
      <div className="bg-primary-600 text-white py-2 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-sm">
          <div className="flex items-center space-x-4">
            <span>Buy it. Sell it. Love it.</span>
          </div>
          <div className="flex items-center space-x-4">
            <span>Have any questions?</span>
            <a href="tel:+61400123456" className="hover:text-primary-200 transition-colors">
              +61 400 123 456
            </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-18">
            ...
            <nav className="hidden md:flex space-x-6 ml-8">
              <Link href="/buy" className="text-gray-900 hover:text-primary-600 px-3 py-2 text-base font-bold transition-colors">
                Buy
              </Link>
              <Link href="/sell" className="text-gray-900 hover:text-primary-600 px-3 py-2 text-base font-bold transition-colors">
                Sell
              </Link>
              <Link href="/rent" className="text-gray-900 hover:text-primary-600 px-3 py-2 text-base font-bold transition-colors">
                Rent
              </Link>
            </nav>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
              <div className="grid grid-cols-3 gap-2 mb-4">
                <Link href="/buy" className="block px-3 py-3 text-center text-gray-900 hover:text-primary-600 hover:bg-gray-50 rounded-lg font-bold transition-colors">
                  Buy
                </Link>
                <Link href="/sell" className="block px-3 py-3 text-center text-gray-900 hover:text-primary-600 hover:bg-gray-50 rounded-lg font-bold transition-colors">
                  Sell
                </Link>
                <Link href="/rent" className="block px-3 py-3 text-center text-gray-900 hover:text-primary-600 hover:bg-gray-50 rounded-lg font-bold transition-colors">
                  Rent
                </Link>
              </div>
              <div className="px-3 py-2 border-t border-gray-200 pt-4">
                ...
                <div className="flex flex-col space-y-2">
                  <Link href="/login" className="block px-3 py-2 text-center text-gray-700 hover:text-primary-600 transition-colors border border-gray-300 rounded-lg">
                    Sign up / Log in
                  </Link>
                  <Link href="/sell" className="block px-3 py-2 text-center bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors">
                    Sell my boat
                  </Link>
                </div>
              </div>
